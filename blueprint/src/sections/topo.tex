\section{Topologie de $\s_n$}
  ...
  \begin{proposition}
    ...
    \uses{def:topo_sn}
    \leanok
    \lean{Bernoulli.bernoulli_is_T2}
  ...
  \begin{proof}
    ...
    \uses{def:topo_sn, prop:dist_equiv}
  ...
  \begin{proposition}
    ...
    \uses{def:topo_sn}
    \leanok
    \lean{Bernoulli.ball_open}
    \lean{Bernoulli.open_iff_countable_ball_union}
  ...
  \begin{proof}
    \proves{prop:boules}
    \uses{prop:separable, prop:dist_equiv}
  ...
  \begin{definition}
    \label{def:cylindres}
    \uses{prop:dist_equiv, def:topo_sn}
    \leanok
