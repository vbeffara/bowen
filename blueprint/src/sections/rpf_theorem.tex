\section{Théorème de Perron-Frobenius de Ruelle}
  ...
  \begin{theorem}[Théorème de Perron-Frobenius de Ruelle]
    \label{thm:rpf}
    \uses{def:transfert_operator, def:holder_fn_set, def:meas_set, def:fn_c0, prop:rpf_1, prop:rpf_2, prop:rpf_3}
  ...
  \begin{proof}
    \proves{prop:rpf_1}
    \uses{def:meas_set} % + Schauder-Tychonoff & Riesz
  ...
  \begin{lemma}
    ...
    \uses{def:fn_c0, def:transfert_operator}
  ...
  \begin{proof}
    ...
    \uses{lem:Lambda_compact} % + Compacité et continuité
