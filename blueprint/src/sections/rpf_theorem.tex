\section{Théorème de Perron-Frobenius de Ruelle}
  ...
  \begin{theorem}[Théorème de point fixe de Schauder-Tychonoff]
    \label{thm:schauder}
    \leanok
    \lean{schauder-tychonoff}

    Soit $K$ un sous-ensemble compact convexe d'un espace vectoriel topologique locallement convexe.
  ...
  \begin{proposition}
    \label{prop:rpf_2}
    \uses{def:transfert_operator, prop:rpf_1}
